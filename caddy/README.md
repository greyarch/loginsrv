...
Login plugin for Caddy, based on [tarent/loginsrv](https://github.com/greyarch/loginsrv).
...
For a full documentation of loginsrv configuration and usage, visit the [loginsrv README.md](https://github.com/greyarch/loginsrv).

A small demo can be found in the [./demo](https://github.com/greyarch/loginsrv/tree/master/caddy/demo) directory.
